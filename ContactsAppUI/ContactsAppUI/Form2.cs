...
namespace ContactsAppUI
{
    public partial class Form2 : Form
    {
        ...
        private void SecondNameTextBox1_TextChanged_1(object sender, EventArgs e)
        {
            try
            {
                _contactsplus.SecondName = SecondNameTextBox1.Text;
        ...
        private void NameTextBox1_TextChanged_1(object sender, EventArgs e)
        {
            try
            {
                _contactsplus.Name = NameTextBox1.Text;
        ...
        private void VKtextBox1_TextChanged_1(object sender, EventArgs e)
        {
            try
            {
        ...
        private void BirthTimePicker1_ValueChanged_1(object sender, EventArgs e)
        {
            try
            {
                _contactsplus.Birth = BirthTimePicker1.Value;
